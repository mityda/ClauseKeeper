...
payload = {"title": "Fix for issue #4", "body": "Closes #4\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-4", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/mityda/ClauseKeeper/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
